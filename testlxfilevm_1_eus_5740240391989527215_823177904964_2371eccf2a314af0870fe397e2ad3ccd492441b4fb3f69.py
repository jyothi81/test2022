...
if __name__ == "__main__":
    if os.getuid() != 0:
        ...
        VMName="iaasvmcontainerv2;linxvmfl;testlxfilevm"
        MachineName="testlxfilevm"
        TargetPortalAddress="pod01-rec2.eus.backup.windowsazure.com"
        TargetPortalPortNumber="3260"
        TargetNodeAddress="iqn.2016-01.microsoft.azure.backup:5740240391989527215-1703442-140738949882389-232076955171103.637823177904964213"
        InitiatorChapPassword="492441b4fb3f69"
        ScriptId="8bbf1dc0-fb92-4754-8a87-f64f96557920"
        TargetUserName="5740240391989527215-2371eccf-2a31-4af0-870f-e397e2ad3ccd"
